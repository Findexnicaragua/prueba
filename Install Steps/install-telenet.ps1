<#
  install-telenet.ps1  --  Instala/actualiza la app de Telenet (Windows).
  ...
  Que hace, solo:
    1. Resuelve y descarga el instalador branded del release "latest" (leyendo el
       manifest version-telenet.json, igual que el auto-update de la app).
    2. Extrae el certificado del MSIX y lo confia (LocalMachine\TrustedPeople).
    3. Instala (o actualiza) la app branded de Telenet.
